    ...
    void OnWizardCreate()
    {
        ...
        if (mesh == null)
        {
            ...
            for (i = 0; i < numVertices; i++)
            {
                ...
                vertices[i + numVertices + 1] = new Vector3(radiusBottom * angleCos, radiusBottom * angleSin, length);
                ...
                if (radiusBottom == 0)
                    normals[i + numVertices + 1] = new Vector3(angleHalfCos * slopeCos, angleHalfSin * slopeCos, -slopeSin);
                else
